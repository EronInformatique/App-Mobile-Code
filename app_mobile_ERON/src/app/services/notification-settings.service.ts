...
getSettingsById(id: number) {
  ...
  console.log(this.errorSaveSetting, this.isSavedConfig)
    ...
    this.httpClient
      .put('https://appmobile-35fbb-default-rtdb.europe-west1.firebasedatabase.app/settings.json', this.settings)
      .subscribe(
        () => {
...
getSettingsFromServer() {
  ...
  this.httpClient
    .get<any[]>('https://appmobile-35fbb-default-rtdb.europe-west1.firebasedatabase.app/settings.json')
    .subscribe(
      (response) => {
        if (response){
